...
/**
 * BitBit Sympathy: a sympathetic-resonance effect. The player's signal barely
 ...
 * bank's root.
 */
class BitBitSympathyProcessor : public juce::AudioProcessor, private juce::AudioProcessorValueTreeState::Listener
{
public:
    BitBitSympathyProcessor();
    ~BitBitSympathyProcessor() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (BitBitSympathyProcessor)
};
