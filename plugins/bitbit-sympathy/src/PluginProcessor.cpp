...
/** A ring / chain-link glyph for the Learn button - "lock the bank onto what I
    am playing". Two interlocked rounded rectangles, the way BitBit Delay draws
    its tempo-link. */
...
BitBitSympathyProcessor::BitBitSympathyProcessor()
...
juce::AudioProcessorValueTreeState::ParameterLayout BitBitSympathyProcessor::createParameterLayout()
{
...
void BitBitSympathyProcessor::prepareToPlay (double newSampleRate, int maximumExpectedSamplesPerBlock)
{
...
void BitBitSympathyProcessor::releaseResources() {}

bool BitBitSympathyProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
...
juce::String BitBitSympathyProcessor::keyReadout() const
{
...
int BitBitSympathyProcessor::trackKey (const float* mono, int numSamples)
{
...
void BitBitSympathyProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer&)
{
...
void BitBitSympathyProcessor::parameterChanged (const juce::String& id, float newValue)
{
    if (id != kLearnID)
        return;
...
juce::AudioProcessorEditor* BitBitSympathyProcessor::createEditor()
{
    ...
    // Ten knobs, five a row, held to a four-knob body the way BitBit Trem & Pan
...
void BitBitSympathyProcessor::installState (const juce::ValueTree& tree)
{
...
void BitBitSympathyProcessor::setStateInformation (const void* data, int sizeInBytes)
{
...
{
    return new BitBitSympathyProcessor();
}
