...
juce::AudioProcessorValueTreeState::ParameterLayout PeakPhaseProcessor::createParameterLayout()
{
...
void PeakPhaseProcessor::prepareToPlay (double newSampleRate, int maximumExpectedSamplesPerBlock)
{
...
bool PeakPhaseProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
...
void PeakPhaseProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer&)
{
