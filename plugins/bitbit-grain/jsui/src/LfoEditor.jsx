...
export default function LfoEditor() {
  ...
  // formatKnobValue("lforate") - see BitBitGrainWebEditor.cpp), reading the
  ...
  // load or a host session restore (BitBitGrainWebEditor's "lfoBreakpoints"
  ...
  //
  // The processor only emits its phase at BitBitGrainWebEditor's own timer
