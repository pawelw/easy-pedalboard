...
class BitBitTapeProcessor : public juce::AudioProcessor
{
public:
    BitBitTapeProcessor();
    ~BitBitTapeProcessor() override = default;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (BitBitTapeProcessor)
};
