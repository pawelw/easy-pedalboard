...
PeakTremPanProcessor::createParameterLayout() {
...
void PeakTremPanProcessor::prepareToPlay(double newSampleRate,
...
bool PeakTremPanProcessor::isBusesLayoutSupported(
...
void PeakTremPanProcessor::processBlock(juce::AudioBuffer<float> &buffer,
                                        juce::MidiBuffer &) {
