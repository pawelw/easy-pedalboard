...
private:
    ...
    // still bit-clean - and it is the same 12 dB/oct roll-off BitBit EQ's hi-cut
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (BitBitWahProcessor)
};
