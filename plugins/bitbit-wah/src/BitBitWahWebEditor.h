...
class BitBitWahProcessor;

/** Spike: BitBit Wah's face built as a React app hosted in a
...
class BitBitWahWebEditor : public juce::AudioProcessorEditor, private juce::Timer
{
public:
    explicit BitBitWahWebEditor (BitBitWahProcessor&);
    ~BitBitWahWebEditor() override;
...
private:
    ...
    // Pushes the live cutoff-sweep modL/modR (see BitBitWahProcessor::lfoModLUi)
    ...
    BitBitWahProcessor& processorRef;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (BitBitWahWebEditor)
};
