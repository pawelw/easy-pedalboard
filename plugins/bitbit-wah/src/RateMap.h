...
/** BitBit Wah's Time knob: one LFO cycle from 30 ms (knob down) to 3 s (knob up) -
    a filter wobble rather than a tremolo throb, so slower at both ends than BitBit
    Trem & Pan.
