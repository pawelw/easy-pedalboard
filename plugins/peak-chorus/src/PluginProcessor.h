...
class PeakChorusProcessor : public juce::AudioProcessor
{
public:
    PeakChorusProcessor();
    ~PeakChorusProcessor() override = default;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (PeakChorusProcessor)
};
