...
juce::AudioProcessorValueTreeState::ParameterLayout PeakChorusProcessor::createParameterLayout()
{
...
void PeakChorusProcessor::prepareToPlay (double newSampleRate, int maximumExpectedSamplesPerBlock)
{
...
bool PeakChorusProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
...
void PeakChorusProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer&)
{
