 ...
 * `ModulationFace` and `ReverbFace` from `@synthpeak/module-face` - BitBit
 * Modulation's and BitBit Reverb's own faces, bound through `mod.` and `rev.` -
 * and the Artifact module, first in the row, is `ArtifactFace` from
 * `@synthpeak/artifact-face` bound through `art.`, BitBit Artifact's own face.
 *
...
export default function App() {
  ...
  // useChainOrder and plugins/bitbit-alpine/src/ChainOrder.h. Dragging a
  ...
  return (
    <div className="page">
      <Card
        ...
        headerCenter={<JucePresetBar variant="separated" showTuner showThemeSwitch showEq />}
