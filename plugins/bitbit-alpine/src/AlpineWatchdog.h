...
/**
 * BitBit Alpine's output-safety black box - dev builds only (EE_ALPINE_WATCHDOG,
 * see plugins/bitbit-alpine/CMakeLists.txt). The safety net itself
 * (BitBitAlpineProcessor::sanitizeOutput) ships in every build; this is only the
