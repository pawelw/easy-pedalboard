...
class BitBitSpringProcessor : public juce::AudioProcessor
{
public:
    BitBitSpringProcessor();
    ~BitBitSpringProcessor() override = default;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (BitBitSpringProcessor)
};
