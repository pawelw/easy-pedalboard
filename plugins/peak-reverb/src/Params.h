...
/** Peak Reverb's parameter ids.
 *
 * Peak Alpine's Reverb module's, exactly, with the `rev.` taken off - which is
...
// Peak Reverb's FDN, which this pedal was on its own before it became a module.
