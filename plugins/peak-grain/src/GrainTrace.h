...
private:
    void timerCallback() override
    {
        ...
        for (const char* id :
             { "size",    "ssync",  "density", "dsync", "time",  "feedback", "stretch", "freeze", "shape", "scatter",
               "reverse", "stereo", "scale",   "root",  "plow",  "puni",     "phigh",   "pmix",   "dtime", "dtsync",
               "dfb",     "dmix",   "decay",   "rmix",  "rvsrc", "dry",      "grains",  "filter", "drive", "on" })
