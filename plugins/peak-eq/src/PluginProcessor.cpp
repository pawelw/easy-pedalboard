...
constexpr std::array<const char *, PeakEqProcessor::kNumBands> kBandIDs { {
    "b100", "b200", "b400", "b800", "b1k6", "b3k2", "b6k4"
} };

// Captions printed under each fader.
constexpr std::array<const char *, PeakEqProcessor::kNumBands> kBandCaptions { {
...
PeakEqProcessor::createParameterLayout() {
...
void PeakEqProcessor::prepareToPlay(double newSampleRate,
...
void PeakEqProcessor::processBlock(juce::AudioBuffer<float> &buffer,
                                   juce::MidiBuffer &) {
