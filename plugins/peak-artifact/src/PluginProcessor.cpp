...
juce::AudioProcessorValueTreeState::ParameterLayout PeakArtifactProcessor::createParameterLayout()
{
    ...
    // be the third, before it moved to Peak Alpine's Modulation module.
    layout.add (
    ...
    // 0..7 dB) and a bipolar Tone tilt (Peak Tape's, flat and bypassed dead
...
void PeakArtifactProcessor::pushSettings() noexcept
{
