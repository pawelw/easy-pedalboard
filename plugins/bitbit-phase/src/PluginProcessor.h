...
class BitBitPhaseProcessor : public juce::AudioProcessor
{
public:
    BitBitPhaseProcessor();
    ~BitBitPhaseProcessor() override = default;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (BitBitPhaseProcessor)
};
