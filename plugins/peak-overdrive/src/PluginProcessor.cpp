...
juce::AudioProcessorValueTreeState::ParameterLayout PeakOverdriveProcessor::createParameterLayout()
{
...
void PeakOverdriveProcessor::prepareToPlay (double newSampleRate, int maximumExpectedSamplesPerBlock)
{
...
bool PeakOverdriveProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
...
void PeakOverdriveProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer&)
{
...
void PeakOverdriveProcessor::setStateInformation (const void* data, int sizeInBytes)
{
