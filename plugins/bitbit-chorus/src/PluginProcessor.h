...
class BitBitChorusProcessor : public juce::AudioProcessor
{
public:
    BitBitChorusProcessor();
    ~BitBitChorusProcessor() override = default;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (BitBitChorusProcessor)
};
