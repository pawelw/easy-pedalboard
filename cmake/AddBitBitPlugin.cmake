...
function(bitbit_add_factory_presets TARGET)
...
function(bitbit_add_plugin TARGET)
    ...
    foreach(required CODE PRODUCT BUNDLE CATEGORIES)
        if(NOT ARG_${required})
            message(FATAL_ERROR "bitbit_add_plugin(${TARGET}): ${required} is required")
        endif()
    endforeach()
    ...
    bitbit_add_factory_presets(${TARGET})
