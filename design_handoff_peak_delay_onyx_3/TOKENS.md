...
[data-pui-theme="onyx"] {
  ...
  --pui-recess:          #101416;
  --pui-recess-ink:      #4d5f65;  /* hairlines/grid only — 2.8:1, never text */
  --pui-tick:            #39474b;
  --pui-tick-lit:        #b9d3d9;
...
[data-pui-theme="onyx"] {
  ...
  --pui-tape-well:      #2b4410;   /* recessed switcher on the band */
...
reads the plain `--pui-*` group — with its value line on
`--pui-ink-soft`, never `--pui-ink-dim`. Contrast check: `--pui-tape-ink-soft` on the
